...
#### OBS: É necessário copiar as configurações do krb5.conf para o namenode secundário e também para o datanode
sudo vi /etc/krb5.conf (Copiar os mesmos dados que foram adicionados no namenode 1)
